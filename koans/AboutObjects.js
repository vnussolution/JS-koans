    ...
    var meglomaniac = { 
      ...
      battleCry: function(noOfBrains) {
        return "They are " + this.henchman + " and the" +
          Array(noOfBrains + 1).join(" " + this.mastermind); // join method is used to fill in the gaps among items in the array, that's why it has only 4 brains
      }
    };
   
    var battleCry = meglomaniac.battleCry(4);
   // console.log(' array(5): ',Array(5).join('1 yes'));
